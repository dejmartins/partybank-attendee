<template>
  <div class="flex flex-col md:flex-row w-full h-[calc(100vh-210px)] overflow-y-auto md:overflow-y-hidden rounded-[20px] bg-[#F9F7F7] p-6 md:p-10 mt-4 border border-[#DDE0E3] custom-scrollbar">
    <div class="w-full md:w-1/3">
      <img :src="eventStore.eventImage || '/defaultImage.png'" alt="Event Image" class="w-full h-auto object-cover rounded-[20px] border border-[#DDE0E3]" />
    </div>
        ...
        <div class="">
            ...
            <div class="border-b pb-2">
                ...
                <div class="flex justify-between font-[400] text-[20px]">
                    ...
                    <p>NGN {{ eventStore.ticketAmount }}</p>
                </div>
            </div>

            <div class="flex justify-between mt-4 text-[28px]">
                <p class="font-[700]">Total Payment</p>
                <p class="font-[700]">NGN {{ total }}</p>
            </div>
        </div>
